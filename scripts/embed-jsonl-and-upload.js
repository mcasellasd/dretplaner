...
const INPUT_FILE = path.join(DATA_DIR, 'impost-societats1.jsonl');
...
async function main() {
    ...
    for (const doc of documents) {
        ...
        points.push({
            ...
            payload: {
                text: doc.text,
                source: doc.meta.source || 'impost-societats1.jsonl',
                chunk_index: doc.id || doc.meta.chunk_index
            }
        });
    }
    ...
    try {
        ...
        console.log("\n✅ Procés finalitzat amb èxit! El fitxer JSONL ha estat incrustat i integrat a la base de coneixement.");
